<template>
    <ul class="c-sidebar-nav">
        ...
        <li class="c-sidebar-nav-title" v-if="hasAnyPermission(['transactions.index'])">TRANSAKSI</li>
        ...
        <li class="c-sidebar-nav-title" v-if="hasAnyPermission(['sales.index']) || hasAnyPermission(['profits.index'])">LAPORAN</li>
        ...
        <li class="c-sidebar-nav-item" v-if="hasAnyPermission(['profits.index'])">
            <Link class="c-sidebar-nav-link" href="/apps/profits" :class="{ 'active': $page.url.startsWith('/apps/profits') }">
                ...
                <span class="ms-2">Laporan Keuntungan</span>
            </Link>
        </li>

        <li class="c-sidebar-nav-title" v-if="hasAnyPermission(['roles.index']) || hasAnyPermission(['permissions.index']) || hasAnyPermission(['users.index'])">PENGATURAN PENGGUNA</li>
        ...
        <li class="c-sidebar-nav-item" v-if="hasAnyPermission(['roles.index'])">
            ...
            <span class="ms-2">Hak Akses</span>
            </Link>
        </li>
