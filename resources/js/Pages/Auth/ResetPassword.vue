                    ...
                    <div class="card-body">
                        ...
                        <form @submit.prevent="submit">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input class="form-control" v-model="form.password_confirmation" :class="{ 'is-invalid': errors.password_confirmation }" type="password" placeholder="Konfirmasi Password">
                            </div>
                            <div class="row">
                                <div class="col-12">
                                    <button class="btn btn-primary shadow-sm rounded-sm px-4 w-100" type="submit">GANTI PASSWORD</button>
                                </div>
                            </div>
                        </form>
                    </div>
