<template>
    ...
    <Head>
        <title>Masuk - Aplikasi Kasir</title>
    </Head>
    <div class="col-md-4">
        <div class="fade-in">
                ...
                <div class="card border-top-purple border-0 shadow-sm rounded-3">
                    <div class="card-body">
                        <div class="text-start">
                            <h5>MASUK</h5>
                            <p class="text-muted">Masuk menggunakan akun mu</p>
                        </div>
                        <hr>
                        ...
                        <form @submit.prevent="submit">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <button class="btn btn-primary shadow-sm rounded-sm px-4 w-100" type="submit">MASUK</button>
                                </div>
                            </div>
                        </form>
                    </div>
