                    ...
                    <div class="col-md-12">
                        <div class="card border-0 rounded-3 shadow border-top-purple">
                            <div class="card-header">
                                <span class="font-weight-bold"><i class="fa fa-chart-bar"></i> LAPORAN PENJUALAN</span>
                            </div>
                            <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="mb-3">
                                                ...
                                                <button class="btn btn-md btn-purple border-0 shadow w-100"><i class="fa fa-filter"></i> SARING</button>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                    ...
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr style="background-color: #e6e6e7;">
                                                <th scope="col">Tanggal Blanja</th>
                                                <th scope="col">No. Nota</th>
                                                <th scope="col">Kasir</th>
                                                <!-- <th scope="col">&customer_id=</th> -->
                                                <th scope="col">Pelanggan</th>
                                                <th scope="col">Point</th>
                                                <th scope="col">Total Blanja</th>
                                        ...
                                        <tbody>
                                            <tr v-for="sale in sales" :key="sale.id">
                                                ...
                                                <td class="text-center">{{ sale.point }}</td>
                                                <td class="text-end">Rp. {{ formatPrice(sale.grand_total) }}</td>

                                            </tr>
                                            <tr>
                                                <td colspan="5" class="text-end fw-bold" style="background-color: #e6e6e7;">GRAND TOTAL</td>
        ...
        setup() {
            ...
            const filter = () => {
                ...
                Inertia.get('/apps/sales/filter', {
                    ...
                    customer_id: customer_id.value.id,
                });
