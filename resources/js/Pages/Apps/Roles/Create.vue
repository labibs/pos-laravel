<template>
    ...
    <Head>
        <title>Tambah Hak Akses Baru - Aplikasi Kasir</title>
    </Head>
    <main class="c-main">
                    ...
                    <div class="col-md-12">
                        <div class="card border-0 rounded-3 shadow border-top-purple">
                            <div class="card-header">
                                <span class="font-weight-bold"><i class="fa fa-shield-alt"></i> TAMBAH HAK AKSES</span>
                            </div>
                            <div class="card-body">
                                ...
                                <form @submit.prevent="submit">
                                    ...
                                    <div class="mb-3">
                                        <label class="fw-bold">Nama Hak Akses</label>
            ...
            const submit = () => {
                ...
                Inertia.post('/apps/roles', {
                    ...
                    onSuccess: () => {
                        ...
                        Swal.fire({
                            title: 'Success!',
                            text: 'Hak Akses Berhasil Di Simpan.',
                            icon: 'success',
