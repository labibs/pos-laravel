<template>
    <Head>
        <title>Tambah Pelanggan Baru - Aplikasi Kasir</title>
    </Head>
    <main class="c-main">
                    ...
                    <div class="col-md-12">
                        <div class="card border-0 rounded-3 shadow border-top-purple">
                            <div class="card-header">
                                <span class="font-weight-bold"><i class="fa fa-user-circle"></i> TAMBAH PELANGGAN BARU</span>
                            </div>
                            <div class="card-body">
            ...
            const submit = () => {
                ...
                Inertia.post('/apps/customers', {
                    ...
                    onSuccess: () => {
                        ...
                        Swal.fire({
                            title: 'Success!',
                            text: 'Pelanggan Berhasil di tambahkan!.',
                            icon: 'success',
