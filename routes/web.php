...
Route::prefix('apps')->group(function() {
    ...
    Route::group(['middleware' => ['auth']], function () {
        ...
        //route transaction tambah qty
        Route::post('/transactions/editProduct', [\App\Http\Controllers\Apps\TransactionController::class, 'editProduct'])->name('apps.transactions.editProduct');

        //route transaction tambah qty
        Route::post('/transactions/editQty', [\App\Http\Controllers\Apps\TransactionController::class, 'editQty'])->name('apps.transactions.editQty');
