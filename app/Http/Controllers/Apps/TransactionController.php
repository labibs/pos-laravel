...
class TransactionController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Apps/Transactions/Indexa', [
            'carts'         => $carts,
    ...
    public function editProduct(Request $request)
    {
        ...
        $cart = Cart::with('product')
            ...
            if($cart->qty >= 10 ){
                $harga = $cart->product->sell_price - 500;
            }else{
                $harga = $cart->product->sell_price;
            }
            $cart->price  = $harga * $cart->qty;

            $cart->save();



        return redirect()->back()->with('success', 'Jumlah Berhasil di tambah!.');
    }
    ...
    public function editQty(Request $request)
    {
        ...
        return redirect()->back()->with('success', 'Jumlah Berhasil di kurangi!.');
    }
    ...
    public function store(Request $request)
    {
        ...
        */
        ...
        $transaction = Transaction::create([
            ...
            'point'         => $request->grand_total/200

        ]);
        //update stock point
        $customer = Customer::find($transaction->customer_id);
        $customer->point = $customer->point + $transaction->point;
        $customer->save();
